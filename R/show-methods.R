...
setMethod("show", "MirnaExperiment", function(object) {
  cat("An object of class MirnaExperiment, which extends MultiAssayExperiment",
      ...
      nrow(experiments(object)[["microRNA"]]), " rows and ",
      ncol(experiments(object)[["microRNA"]]), " columns\n",
      "\t- gene expression values: ", class(experiments(object)[["genes"]]),
      " with ", nrow(experiments(object)[["genes"]]), " rows and ",
      ncol(experiments(object)[["genes"]]), " columns\n",
      "\t- samples metadata: ", class(colData(object)), " with ",
      nrow(colData(object)), " rows and ", ncol(colData(object))," columns\n",
