...
visualizeNetwork <- function(object,
    ...
    if (!is(object, "IntegrativePathwayAnalysis")) {
        stop(
            paste(
                "'object' should be of class IntegrativePathwayAnalysis!",
    ...
    if (!is.character(pathway) |
        ...
        stop(
            paste(
                "'pathway' must be the name of a valid pathway included in",
    ...
    if (!is.character(algorithm) |
        ...
        stop(
            paste(
                "'algorithm' must be either 'dot' (default), 'circo', 'fdp'",
    ...
    if (length(lfcScale) != 3 |
        ...
        stop(paste(
            "'lfcScale' must be a vector with R color names for",
    ...
    if (!is.null(subgraph) &
        ...
        stop(
            paste(
                "'subgraph' must contain the names of nodes to",
    ...
    if (!is.null(highlightNodes) &
        ...
        stop(
            paste(
                "'highlightNodes' must contain the names of nodes to",
    ...
    if (!is.logical(legendColorbar) |
        ...
        stop(
            paste(
                "'legendColorbar' must be logical (TRUE/FALSE)!",
                "See ?visualizeNetwork"
            ),
            call. = FALSE
        )
    ...
    if (!is.logical(legendInteraction) |
        ...
        stop(
            paste(
                "'legendInteraction' must be logical (TRUE/FALSE)!",
                "See ?visualizeNetwork"
            ),
            call. = FALSE
        )
    ...
    if (!(is.character(title) | is.null(title)) |
        ...
        stop(
            paste(
                "'title' must be the title of the network.",
                "For additional details see ?visualizeNetwork"
            ),
            call. = FALSE
        )
...
enrichmentDotplot <- function(enrichment,
    ...
    if (!is.character(showTerms) &
        ...
        stop(
            paste(
                "'showTerms' must be the number of top enriched terms",
    ...
    if (!is.character(showTermsParam) |
        ...
        stop(
            paste(
                "'showTermsParam' must be one of: 'ratio' (default), 'padj',",
                "'pval', 'overlap'"
            ),
            call. = FALSE
        )
    ...
    if (!(is.character(title) | is.null(title)) |
        ...
        stop(
            paste(
                "'title' must be the title of the plot (e.g. 'Enrichment').",
...
gseaRidgeplot <- function(enrichment,
    ...
    if (!is.character(showTermsParam) |
        ...
        stop(
            paste(
                "'showTermsParam' must be one of: 'ratio', 'padj' (default),",
                "'pval', 'overlap'"
            ),
            call. = FALSE
        )
    ...
    if (enrichmentMethod(enrichment) != "Gene-Set Enrichment Analysis (GSEA)") {
        stop(
            paste(
                "To use this function, 'enrichment' must originate from a",
    ...
    if (!requireNamespace("ggridges", quietly = TRUE)) {
        stop(
            paste(
                "The ggridges package is needed to use",
    ...
    ridgeDf <- data.frame(
        pathway = rep(res$pathway, setLen),
...
mirVariantPlot <- function(variantId,
    ...
    if (!is.data.frame(snpAssociation) |
        ...
        stop(
            paste(
                "'snpAssociation' must be a data.frame containing the",
    ...
    if (!(is.character(title) | is.null(title)) |
        ...
        stop(
            paste(
                "'title' must be the title of the plot (e.g. 'SNPs overlap').",
    ...
    if (!requireNamespace("GenomicRanges", quietly = TRUE)) {
        stop(
            paste(
                "The GenomicRanges package is needed to use",
                "this function. Install it through:",
    ...
    if (!requireNamespace("Gviz", quietly = TRUE)) {
        stop(
            paste(
                "The Gviz package is needed to use",
                "this function. Install it through:",
    ...
    if (showSequence == TRUE) {
        if (!requireNamespace("BSgenome.Hsapiens.UCSC.hg38", quietly = TRUE)) {
            stop(
                paste(
                    "The BSgenome.Hsapiens.UCSC.hg38 package is needed to use",
                    "this function. Install it through:",
    ...
    if (showContext == TRUE) {
        if (!requireNamespace("biomaRt", quietly = TRUE)) {
            stop(
                paste(
                    "The biomaRt package is needed to use this function",
...
plotCorrelation <- function(mirnaObj,
    ...
    if (pairedSamples(mirnaObj) == FALSE) {
        stop(paste(
            "Correlation analysis can only be performed for paired",
    ...
    if (!is.character(mirna) |
        ...
        stop(
            paste(
                "'mirna' must be a valid miRNA name that is present in",
    ...
    if (!is.character(gene) |
        ...
        stop(
            paste(
                "'gene' must be a valid gene name that is present in",
    ...
    if (is.null(condition)) {
        if (mirnaObj@mirnaDE$group != mirnaObj@geneDE$group) {
            stop(
                paste(
                    "For unpaired data, the 'group' variable used for",
        ...
        if (length(mirnaObj@mirnaDE$group) == 0 |
            ...
            stop(
                paste(
                    "For objects where differential expression has been manually",
    ...
    if (!is.null(condition)) {
        if (length(condition) == 1) {
            if (!is.character(condition) |
                ...
                stop(
                    paste(
                        "'condition' must be the column name of a variable present",
    ...
    if (!is.character(lineType) |
        ...
        stop(
            paste(
                "'lineType' must be either 'blank', 'solid', 'dashed'",
    ...
    if (grepl("correlation", mirnaObj@integration$method) == FALSE) {
        stop(paste(
            "Correlation analysis must be performed before using this",
    ...
    if (useRanks == TRUE & corMethod == "pearson") {
        warning(paste(
            "It's not possible to represent Pearson's correlation",
    ...
    if (!is.null(colorScale)) {
        if (!is.character(colorScale) |
            ...
            stop(
                paste(
                    "'colorScale' must be a named character vector where values",
    ...
    if (regression == TRUE) {
        if (useRanks == TRUE | corMethod == "pearson") {
            ...
            if (!requireNamespace("MonoPoly", quietly = TRUE)) {
                stop(
                    paste(
                        "The MonoPoly package is needed to plot correlations",
...
plotDE <- function(mirnaObj,
    ...
    if (!is.character(features) |
        ...
        stop(
            paste(
                "'features' must be a character vector containing miRNA and/or",
    ...
    if (!is.character(graph) |
        ...
        stop(
            paste(
                "'graph' must be either 'boxplot' (default), `barplot`",
    ...
    if (!is.character(pCol) |
        ...
        stop(
            paste(
                "'pCol' must be either 'P.Value' or 'adj.P.Val' (default).",
                "For additional details see ?plotDE"
            ),
            call. = FALSE
        )
    ...
    if (nameAsTitle == TRUE & length(features) > 1) {
        warning(
            paste(
                "'nameAsTitle' can only be used for 1 miRNA/gene!",
...
plotVolcano <- function(mirnaObj,
    ...
    if (!is.null(labels)) {
        if (!is.numeric(labels) &
            ...
            stop(
                paste(
                    "'labels' must be a character vector indicating the features",
    ...
    if (!is.character(interceptType) |
        ...
        stop(
            paste(
                "'interceptType' must be either 'blank', 'solid', 'dashed'",
                "(default), 'dotted', 'dotdash', 'longdash' or 'twodash'.",
                "For additional details see ?plotCorrelation"
            ),
            call. = FALSE
    ...
    if (length(colorScale) != 3 |
        any(areColors(colorScale) == FALSE)) {
        stop(paste(
            "'colorScale' must be a vector with R color names for",
            "downregulated features, non significant features, and",
            "upregulated features. The default value is",
            "c('blue', 'grey', 'red')."
        ), call. = FALSE)
    ...
    if (!(is.character(title) | is.null(title)) |
        ...
        stop(
            paste(
                "'title' must be the title of the plot.",
    ...
    if (!is.null(labels)) {
        if (!requireNamespace("ggrepel", quietly = TRUE)) {
            stop(
                paste(
                    "The ggrepel package is needed to show labels in",
                    "this function. Install it through:",
...
plotDimensions <- function(mirnaObj,
    ...
    if (length(condition) == 1) {
        if (!is.character(condition) |
            ...
            stop(
                paste(
                    "'condition' must be the column name of a variable specified",
                    "in the metadata (colData) of a MirnaExperiment object; or,",
                    "alternatively, it must be a character/factor object that",
                    "specifies group memberships."
                ),
    ...
    if (!is.numeric(dimensions) |
        ...
        stop(
            paste(
                "'dimensions' must be a numeric vector of length 2, that",
    ...
    if (!is.null(condition)) {
        Condition <- cond
        mdsPlot <- ggplot2::ggplot(mds, ggplot2::aes(
            x = .data$x,
            y = .data$y,
            color = Condition,
            label = .data$primary
...
integrationDotplot <- function(object,
    ...
    if (!is.character(showTerms) &
        ...
        stop(
            paste(
                "'showTerms' must be the number of top significant pathways",
                "to plot or, alternatively, a character vector containing",
    ...
    if (!is.character(showTermsParam) |
        length(showTermsParam) != 1 |
        !showTermsParam %in% c(
            "coverage", "padj", "pval", "score",
            "normalized.score"
        )) {
        stop(
            paste(
                "'showTermsParam' must be one of: 'coverage', 'padj',",
