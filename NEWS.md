...
This new release of MIRit fixes the rendering of the vignette and updates the
documentation website. GitHub worflows have also been updated.

# MIRit 1.7.3

This version fixes some minor bugs in the integration analysis, and adds
references to the new manuscript in the documentation, README, CITATION, and
vignette. A new setTargets() function has also been included.
