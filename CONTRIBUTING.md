...
This outlines how to propose a change to MIRit. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jacopo-ronchi/MIRit", fork = TRUE)`.
...
Please note that the MIRit project is released with a [Contributor Code
of Conduct](https://jacopo-ronchi.github.io/MIRit/CODE_OF_CONDUCT.md).
